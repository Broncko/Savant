 ...
 */
class EProject extends EException {}

/**
 * @package Savant
 * provides an application template
 */
class CProject implements IProject
{
    /**
     * application name
     * @var string
    ...
    public static function loadClass($pClass)
    {
        ...
        $lib = self::$LIB_DIR;
        $classPath = function($class) use ($lib)
        {
            return $lib.\DIRECTORY_SEPARATOR.str_replace('_',\DIRECTORY_SEPARATOR,$class).'.php';
        };
